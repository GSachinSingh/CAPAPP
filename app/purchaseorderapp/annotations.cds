...
annotate service.POs with @(
    ...
    UI.Identification:[
        ...
        },
        {
            ...
            Action        : 'AdminService.setOrderProcessing'
        }
    ],
...
annotate AdminService.POs with {
    PARTNER_GUID@(
        Common : { 
            Text : PARTNER_GUID.COMPANY_NAME,
         },
         ValueList.entity: AdminService.BusinessPartnerSet
    )
};

annotate AdminService.PurchaseOrderItems with {
    PRODUCT_GUID@(
        Common : { 
            Text : PRODUCT_GUID.DESCRIPTION,
         },
         ValueList.entity: AdminService.ProductSet
    )
};

@cds.odata.valuelist
annotate AdminService.BusinessPartnerSet with @(
    UI.Identification:[{
        $Type : 'UI.DataField',
        Value : COMPANY_NAME,
    }]
...
@cds.odata.valuelist
annotate AdminService.ProductSet with @(
    UI.Identification:[{
        $Type : 'UI.DataField',
        Value : DESCRIPTION,
    }]
